...
The following structure of this paper is as follows: Section @sec-mydatasection presents the data sources and methodology, followed by Section 3, which discusses the results and their implications. Section 4 concludes with a discussion of the limitations of the study and suggestions for future research.
